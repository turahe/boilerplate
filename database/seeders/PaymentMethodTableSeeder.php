    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'description' => 'Pay by bank wire transfer,  transfer the invoice amount via wire transfer to the merchant account and confirm manually. After payment confirmation the goods will be shipped.',
                'admin_description' => 'Pay by bank wire transfer,  transfer the invoice amount via wire transfer to the merchant account and confirm manually. After payment confirmation the goods will be shipped.',
                'admin_help_doc_link' => '',
                'order' => 6,
                'created_at' => Carbon::Now(),
                'updated_at' => Carbon::Now(),
